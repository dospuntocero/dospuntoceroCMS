...
(function($) {
    ...
    $.fn.activebar = function( options ) {
        ...
        $( '.ieUpdateContent', $.fn.activebar.container ).empty();

        // Use all provided elements as new content source
        $(this).each( function() {
            $( '.ieUpdateContent', $.fn.activebar.container ).append( this );
        });
     ...
     ****************************************************************/
     ...
     function initializeActivebar( options ) {
        ...
        container.append( 
          $( '<div></div>' ).attr( 'class', 'ieUpdateContent' )
          .css({
            'margin': '0px 8px',
            'paddingTop': '1px'
          })
